    ...
    >
      ...
      >
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">add advert</span>
              </a>
            </li>
          </ul>
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo e(route('dispatcher')); ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo e(route('advt_list')); ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">список обьявлений в базе</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo e(route('akk_list')); ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo e(route('new_advrt')); ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
        ...
        <!--   <div class="px-6 my-6">
          ...
          <div class="px-6 my-6">
              Вы вошли как : <?php echo e(Auth::user()->name  ?? 'Гость'); ?>
